...
export default function RootLayout({
    ...
    const sidebarItemsPadnit = [
        { id: "dashboard", icon: <Home size={20} />, label: "Dashboard Overview ", path: "/admin/profile/dashboard" },
        { id: "MyPujaList", icon: <Users size={20} />, label: "Puja Management", path: "/admin/profile/pujamanage" },
        {
            id: "UpcomingOrders",
            icon: <BarChart3 size={20} />,
            label: "Pandit & Devotee Support ",
            path: "/profile/dashboard/pandit/upcomingorders"
        },
        {
            id: "CompletedOrders",
